...
MODULE_ALIAS("pci:v000010EEd00007028sv000010EEsd00000007bc*sc*i*");
MODULE_ALIAS("pci:v000010EEd00008038sv000010EEsd00001247bc*sc*i*");

MODULE_INFO(srcversion, "705774F3E0A006A4495AF5F");
