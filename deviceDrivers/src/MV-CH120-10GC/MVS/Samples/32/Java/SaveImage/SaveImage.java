/***************************************************************************************************
 * @file      SaveImage.java
 * @breif     Use functions provided in MvCameraControlWrapper.jar to save image as 
 * @author    zhanglei72
 * @date      2020/02/10
 *
 * @warning  
...
public class SaveImage
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            int bufferSize = stImageInfo.width * stImageInfo.height * 4;    // Every RGB pixel takes 3 bytes
            ...
            stSaveParam.bufferSize = bufferSize;                                        // output image buffer size
            stSaveParam.imageType = MV_SAVE_IAMGE_TYPE.MV_Image_Jpeg;               // output image pixel format
  
            stSaveParam.methodValue = 2;                                            // Interpolation method that converts Bayer format to RGB24.  0-Neareast 1-double linear 2-Hamilton
           ...
           // nRet = MvCameraControl.MV_CC_SaveImage(hCamera, stSaveParam);
            ...
            saveDataToFile(imageBuffer, stSaveParam.imageLen, "SaveImage99.jpeg");
